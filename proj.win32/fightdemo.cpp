    ...
    int       nCmdShow)
{
    ...
    return FightdemoPlayer::createAndRun();
}

int FightdemoPlayer::createAndRun(void)
{
    FightdemoPlayer *host = FightdemoPlayer::sharedInstance();
    int ret = host->run();
    FightdemoPlayer::purgeSharedInstance();
    return ret;
}

FightdemoPlayer *FightdemoPlayer::s_sharedInstance = NULL;

FightdemoPlayer *FightdemoPlayer::sharedInstance(void)
{
    if (!s_sharedInstance)
    {
        s_sharedInstance = new FightdemoPlayer();
    }
    return s_sharedInstance;
}

void FightdemoPlayer::purgeSharedInstance(void)
{
    if (s_sharedInstance)
    {
...
FightdemoPlayer::FightdemoPlayer(void)
: m_app(NULL)
, m_hwnd(NULL)
, m_exit(TRUE)
...
int FightdemoPlayer::run(void)
{
    ...
    do
    {
        ...
        SetWindowTextA(m_hwnd, "fightdemo-player");
...
void FightdemoPlayer::loadProjectConfig(void)
{
    vector<string> args;
...
void FightdemoPlayer::createViewMenu(void)
{
...
void FightdemoPlayer::updateMenu(void)
{
    HMENU menu = GetMenu(m_hwnd);
    HMENU viewMenu = GetSubMenu(menu, 1);
...
void FightdemoPlayer::updateWindowTitle(void)
{
}

void FightdemoPlayer::relaunch(void)
{
...
void FightdemoPlayer::writeDebugLog(const char *log)
{
...
// menu callback
void FightdemoPlayer::onFileOpenProject(void)
{
...
void FightdemoPlayer::onFileCreateProjectShortcut(void)
{
    ...
    if (SUCCEEDED(hres))
    {
        ...
        psl->SetDescription(L"FightdemoPlayer");
...
void FightdemoPlayer::onFileProjectConfig(void)
{
...
void FightdemoPlayer::onFileRelaunch(void)
{
    relaunch();
}

void FightdemoPlayer::onFileExit(void)
{
    DestroyWindow(m_hwnd);
}

void FightdemoPlayer::onViewChangeFrameSize(int viewMenuID)
{
...
void FightdemoPlayer::onViewChangeOrientation(int viewMenuID)
{
    bool isLandscape = m_project.isLandscapeFrame();
...
void FightdemoPlayer::onViewChangeZoom(int scaleMode)
{
    float scale = 1.0f;
...
void FightdemoPlayer::onHelpAbout(void)
{
    DialogBox(GetModuleHandle(NULL), MAKEINTRESOURCE(IDD_ABOUTBOX), m_hwnd, AboutDialogCallback);
}

// windows callback
LRESULT FightdemoPlayer::WindowProc(UINT message, WPARAM wParam, LPARAM lParam, BOOL* pProcessed)
{
    int wmId, wmEvent;
    FightdemoPlayer *host = FightdemoPlayer::sharedInstance();
...
INT_PTR CALLBACK FightdemoPlayer::AboutDialogCallback(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam)
{
